                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server" Height="36px" OnClick="LinkButton4_Click" Width="36px"><i class="fas fa-check-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-success mr-1" ID="LinkButton1" runat="server" Height="36px" OnClick="LinkButton1_Click" Width="36px"><i class="fas fa-check-circle"></i></asp:LinkButton>
                              <asp:LinkButton class="btn btn-warning mr-1" ID="LinkButton2" runat="server" Height="36px" OnClick="LinkButton2_Click" Width="36px"><i class="far fa-pause-circle"></i></asp:LinkButton>
                              <asp:LinkButton class="btn btn-danger mr-1" ID="LinkButton3" runat="server" Height="36px" OnClick="LinkButton3_Click" Width="36px"><i class="fas fa-times-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                  </div>
