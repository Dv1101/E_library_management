...
namespace E_library_management
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (checkbook())
            {
                Response.Write("<script>alert('Book already exist !!!, Try with some other Book ID . ');</script>");
            }
            else
            {
                addNewBook();
        ...
        bool checkbook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_master_tbl where book_id='" + TextBox1.Text.Trim() + "' OR book_id='"+ TextBox2.Text.Trim()+"';", con);
